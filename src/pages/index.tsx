    ...
    <>
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <header className="flex h-header w-full fixed top-0 left-0 z-50 py-4 items-center justify-between bg-soundscape-blue-bg 
          ...
          <HiMenu className="2xl:hidden xl:hidden lg:flex md:flex tablet:flex mobile:flex" style={{ 'cursor': 'pointer'}} color="white" size={"2.5rem"} />
        </header>
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className='flex flex-col h-main-hero w-full relative justify-between'>
          <Image className="absolute h-full object-cover z-10
                            2xl:object-hero-big-screen xl:object-hero-big-screen  lg:object-hero-big-screen  md:object-left-top tablet:object-left-top  mobile:object-left-top" src={heroBgImg.src} height={0} width={0} alt={heroBgImg.alt}/>
          <div className="flex flex-col z-30 gap-6 mx-20
                          2xl:mx-20  xl:mx-20 lg:mx-20   md:mx-16  tablet:mx-8  mobile:mx-6
                          2xl:items-start  xl:items-start lg:items-start   md:items-center  tablet:items:center  mobile:items-center
                          2xl:mt-36 xl:mt-36  lg:mt-24  md:mt-24  tablet:mt-24  mobile:mt-24
                          2xl:w-[45vw]  xl:w-[45vw]  lg:w-[35vw]  md:w-fill-available  tablet:w-fill-available  mobile:w-fill-available ">
              <h2 className="w-full  text-soundscape-white text-hero-title font-bold leading-none
                            2xl:text-left xl:text-left lg:text-center md:text-center tablet:text-center mobile:text-center">
                Soundscape&nbsp; 
                <br className="2xl:hidden xl:hidden lg:flex md:flex tablet:flex mobile:flex"/>
                <span  className="2xl:text-hero-title xl:text-hero-title lg:text-hero-title-sub md:text-hero-title-sub tablet:text-hero-title-sub mobile:text-hero-title-sub">for Everyone</span> 
              
              </h2>
              <p className="font-work-sans font-normal w-full text-left text-soundscape-white 
                            2xl:text-3xl xl:text-3xl lg:text-2xl  md:text-2xl  tablet:text-2xl  mobile:text-2xl">
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className="flex flex-col w-full h-auto bg-soundscape-grey-bg py-28 
                        2xl:px-20 xl:px-20 lg:px-20 md:px-20 tablet:px-10 mobile:px-10">
          ...
          <div className="flex flex-row flex-wrap w-full h-auto
                          2xl:px-20 xl:px-20 lg:px-20 md:px-20 tablet:px-10 mobile:px-0">
            <div className="flex h-auto py-12
                            2xl:items-start xl:items-start lg:items-start md:items-center tablet:items-center mobile:items-center
                            2xl:flex-row xl:flex-row lg:flex-row md:flex-col tablet:flex-col mobile:flex-col
                            2xl:basis-1/2 xl:basis-1/2 lg:basis-full md:basis-full tablet-basis:full mobile:basis-full ">
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className="flex flex-col w-full h-auto bg-soundscape-white py-28
                        2xl:px-20 xl:px-20 lg:px-20 md:px-20 tablet:px-10 mobile:px-10">
          <div className="flex flex-row flex-wrap w-full h-auto">
            <div className="flex justify-center xl:basis-1/2 lg:basis-full md:basis-full tablet-basis:full  lg:pb-6 md:pb-6 tablet:pb-6 mobile:pb-6">
              <Image className="h-section-img w-auto rounded-section-image" src={groupIntroImg.src} height={0} width={0} alt={groupIntroImg.alt}/>
            </div>
            <div className="flex flex-col xl:basis-1/2 lg:basis-full md:basis-full tablet-basis:full xl:pl-10 py-4 gap-6">
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className="flex flex-col w-full h-auto bg-soundscape-blue py-28 
          ...
          <div className="xl:basis-7/12 lg:basis-full lg:w-full mb-8 md:basis-full md:w-full tablet:basis-full tablet:w-full xl:pl-10 mobile:basis-full">
            ...
            <div className="flex flex-col xl:basis-5/12 lg:basis-full md:basis-full tablet-basis:full   py-4 gap-6">
        ...
        <div className="flex flex-col w-full h-auto bg-soundscape-blue py-28
          ...
          <div className="flex flex-row flex-wrap w-full h-auto gap-8">
            ...
            <div className="flex gap-8 basis-eList-2  
                            2xl:basis-eList-2  xl:basis-eList-2  lg:basis-eList-2  md:basis-eList-2  tablet:basis-full mobile:basis-full
                            2xl:flex-row xl:flex-row lg:flex-row md:flex-row tablet:flex-col mobile:flex-col" >
              <div className="flex flex-col gap-2">
                <input type="text" placeholder="Email Address" style={{'borderColor': 'lightgrey', 'color': 'lightgrey'}} 
                        className="flex px-4 py-3 w-96 text-lg rounded-primary-input bg-soundscape-input-bg border-2 border-gray-200 outline-0 text-gray-300
                                   2xl:w-96 xl:w-96 lg:w-96 md:w-96 tablet:w-full mobile:w-full" /> 
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className="flex flex-col w-full h-auto bg-soundscape-white py-28
          ...
          <div className="flex w-full gap-16
                          2xl:flex-row xl:flex-row lg:flex-row md:flex-row tablet:flex-col mobile:flex-col">  
            <div className="flex 2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-1/2 tablet:w-full mobile:w-full ">
