    ...
    <>
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <header className="flex h-header w-full fixed top-0 left-0 z-50 px-16 py-4 items-center justify-between bg-soundscape-blue-bg "> 
          ...
          <HiMenu className="2xl:hidden xl:hidden lg:flex md:flex sm:flex" style={{ 'cursor': 'pointer'}} color="white" size={"2.5rem"} />
        </header>
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className="flex flex-col w-full h-auto bg-soundscape-grey-bg py-28 px-20">
          ...
          <div className="flex flex-row flex-wrap w-full h-auto px-20 ">
            <div className="flex flex-row 2xl:basis-1/2 xl:basis-1/2 lg:basis-full h-auto py-12">
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className="flex flex-col w-full h-auto bg-soundscape-white py-28 px-20">
          <div className="flex flex-row flex-wrap w-full h-auto">
            <div className="flex justify-center xl:basis-1/2 lg:basis-full md:basis-full sm-basis:full  lg:pb-6 md:pb-6 sm:pb-6">
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------------------------ */}
        <div className="flex flex-col w-full h-auto bg-soundscape-white py-28 px-20">
          <div className="flex flex-row  flex-wrap justify-center w-full h-auto">
