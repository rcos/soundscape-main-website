        ...
        <header className="flex h-header w-full fixed top-0 left-0 z-50 py-4 items-center justify-between bg-navy-blue-bg 
          ...
          <div className="tv:flex desktop:flex laptop:hidden m:hidden tablet:hidden mobile:hidden"> 
            { HeaderLinks.map((element, index) => {
              return (
                <Link className="flex h-10 w-auto text-white text-center items-center text-base px-4 mx-3 cursor-pointer rounded-header-btn hover:bg-white hover:text-dark-blue " href={'https://ialabs.ie/privacy-policy/'} onClick={notifyPageMissing} key={index}>
                  {element}
                </Link>
              )
            })}
